...
int main(){
    ...
    // For Loop to Traverse Array using mid
    for(mid = 0; mid < n ; mid++){
        ...
        if(mid <= high){
            ...
            // For Case 2 we Swap mid and high i.e add element at the end
                ...
                // Since By Default the loop will increment mid here we will decrement it so that its value remained unchanged for this iteration
                // This is done so that after swapping it will check the value
                // To Ensure that after Swapping with high array will check the value
                mid--;
            }
