...
int main(){
    ...
    // Since here we are using while loop we will directly check the condition here
    ...
    while(mid <= high){
            ...
            if(arr[mid] == 0){
                ...
                low++;
                // Incrementing mid value as while loop dosen't automatically increment variable value
                mid++;
            }
            ...
            // Condition for 1
            // No Swapping is done we directly increment mid
            else{
            // Incrementing mid value as while loop dosen't automatically increment variable value
            mid++;
