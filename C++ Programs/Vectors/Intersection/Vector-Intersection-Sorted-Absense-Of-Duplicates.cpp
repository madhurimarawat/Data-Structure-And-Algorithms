...
int main(){
    ...
    vector<int> vec_in;
    vector<int> vec_in_Unique;
    vector<int> vec_in_Unique_Sorted;
    ...
    cout<<"\nSorted Intersection of Vector With Absense of Duplicates is:\n"<<endl;
    vec_in = intersection(v1,v2);
    vec_in_Unique = unique_Vector(vec_in);
    vec_in_Unique_Sorted = bubble_Sort(vec_in_Unique);
    print_Vector(vec_in_Unique_Sorted);
